...
@Component({
  selector: 'app-admin-raw-auth-logs',
  templateUrl: './raw-auth-logs.component.html',
  styleUrls: ['./raw-auth-logs.component.css']
})
export class AdminRawAuthLogsComponent implements OnInit {
  ...
  ngOnInit(): void {
    setTimeout(() => {
      this.AdminLayoutComponent.loadPageTitle("Raw Auth Logs", "", "Raw Auth Logs")
    });
