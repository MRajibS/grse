            ...
            if _user is None:
                ...
                try:
                    ...
                    User_fingerprints.add_fingerprint(user_id=usr_data.id,
                                                      alpeta_user_id=request.form['alpeta_user_id'],
                                                      fingerid=alpeta_fingerprint_data['FingerID'],
                                                      totalsize=alpeta_fingerprint_data['TotalSize'],
                                                      template1=alpeta_fingerprint_data['Template1'],
                                                      template2=alpeta_fingerprint_data['Template2'],
                                                      convimage1=alpeta_fingerprint_data['ConvImage1'],
                                                      convimage2=alpeta_fingerprint_data['ConvImage2'])
                ...
                params = {
                    ...
                    "UserFPInfo": [{
                        ...
                        "MinConvType": 3,
                        "TemplateIndex": 1,
                        "TemplateData": alpeta_fingerprint_data['Template1']
                    },
                        {
                            "FingerID": alpeta_fingerprint_data['FingerID'],
                            "MinConvType": 3,
                            "TemplateIndex": 2,
                            "TemplateData": alpeta_fingerprint_data['Template2']
                        }
                    ],
                    "UserCardInfo": [{
    ...
    def post(self,role_id,page):
        try:
            ...
            if search_status == True:
                # search_query = Users.query.filter(Users.employee_id.match(search)).all()
                # query = Users.query.filter(or_(Users.role_id == role_id,
                #                                       Users.first_name.like(search),
                #                                       Users.last_name.like(search),
                #                                       Users.alpeta_user_id.like(search)))

                search_query = Users.query.filter(or_(Users.employee_id.like(search),
                                                      Users.first_name.like(search),
                                                      Users.last_name.like(search),
                                                      Users.alpeta_user_id.like(search)))
