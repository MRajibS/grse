...
class Users(db.Model):
    ...
    def __init__(self, employee_id, department_id, vendor_id, alpeta_user_id, designation_id, role_id, shift_id, first_name,
    ...
    def addUser(employee_id, department_id, alpeta_user_id,vendor_id, designation_id, role_id, shift_id, first_name,
                 middle_name, last_name, dob, gender, nationality,marital_status, address, email, phone ,esi_no ,pf_no
                ,password ,alpeta_password ,profile_picture):
    ...
    def UpadteUser(id,employee_id, department_id, vendor_id, alpeta_user_id, designation_id, role_id, shift_id, first_name,
                 middle_name, last_name, dob, gender, nationality,marital_status, address, email, phone ,esi_no ,pf_no
                 ,employment_start_date ,employment_end_date ,password ,alpeta_password ,
                profile_picture):
...
class User_terminals(db.Model):
    ...
    def __init__(self, user_id, terminal_id,status, created_at, updated_at):
        self.user_id = user_id
...
class Terminals(db.Model):
    ...
    def __init__(self, name, short_code,terminal_type,description,status, created_at, updated_at):
        self.name = name
...
class User_fingerprints(db.Model):
    ...
    def FetchUserFingerPrintDetails_By_ID(user_id):
        query = User_fingerprints.query.filter_by(user_id=user_id).first()
        UserFprintsSchema = User_facedatas_schema()
        UserFprintsSchema = User_facedatas_schema(many=True)
