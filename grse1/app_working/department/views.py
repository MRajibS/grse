...
class fn_View_AllDepartment(MethodView):
    ...
    @swag_from('apidocs/AllDepartments.yaml', methods=['GET'])
    def get(self):
        try:
            ...
            respone = {"status":'success',"message":"Success", "departments":output}
...
Department_View.add_url_rule('/all_departments', view_func=fn_View_AllDepartment, methods=['GET'])
