            ...
            if _user is None:
                try:
                    ...
                    usr_data = Users.addUser(employee_id=request.form["employee_id"],
                                    ...
                                    profile_picture=alpeta_face_data[1]['TemplateData']
                        ...
                        if ResultCode == 0:
                            ...
                            Users.query.filter(Users.employee_id == request.form["employee_id"]).update(
                                {Users.alpeta_user_id: None,
                                 Users.profile_picture: usr_data.employee_id,
                                 })
                            db.session.flush()
                            db.session.commit()
                ...
                try:
                    ...
                    Users.query.filter(Users.employee_id == request.form["employee_id"]).update(
                        {Users.alpeta_user_id: request.form["alpeta_user_id"],
                         Users.profile_picture: alpeta_face_data[1]['TemplateData'],
                         Users.costcntr: request.form["costcntr"],
                        Users.shift_id: request.form["shift_id"],
                    Users.designation_id:request.form["designation_id"],
    ...
    def post(self,role_id,page):
        try:
            ...
            if search_status == True:
                search_query = Users.query.filter(Users.role_id==role_id,Users.employee_id.like(search)).all()
                ...
                query = Users.query.filter_by(role_id=role_id).order_by(desc(Users.updated_at)).all()
                Userschema = User_schema(many=True)
...
class fn_Update_ProfilePIC(MethodView):
    ...
    def post(self):
        try:
            ...
            response = Update_USER_ProfilePIC(id=id,image_str=img_str,type=type)
            return make_response(jsonify(response)), 200
        except Exception as e:
            response = {"status": 'error', "message": f'{str(e)}'}
            return make_response(jsonify(response)), 200
    ...
    def get(self, id):
        try:
            ...
            details_json = {"UserDetails":UserDetails,"DepartmentDetails":DepartmentDetails,
                            ...
                            "FaceData":FaceData,"TerminalDetails":TerminalDetails}
