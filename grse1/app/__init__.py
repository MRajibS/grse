...
def create_app(config_name):
    app = Flask(__name__, template_folder="C:\\Users\\datacore\\Desktop\\html\\grse1\\templates")
    ...
    @app.route('/<name>/<aadhar>')
    def generate_pdf(name, aadhar):

        response = render_template("user_template.html", id=aadhar, name=name)
        res = pdfkit.from_string(response, False)
